...
import { MoreHorizontal, TrendingUp, Calendar, DollarSign, Users, Home, Search, Bell, Menu, User, Award } from 'lucide-react';
...
const AgentDashboard = () => {
  ...
  const renderSegments = (current, total, count = 15) => {
    ...
    for (let i = 0; i < count; i++) {
      segments.push(<div key={i} className={`h-1.5 w-1 mx-0.5 rounded-sm ${i < filledSegments ? 'bg-white' : 'bg-gray-800'}`} style={{
      ...
      <div className="p-3 grid grid-cols-1 md:grid-cols-2 gap-3 max-w-[1600px] mx-auto">
        ...
        <Card className="bg-black border-gray-800 shadow-lg col-span-1">
          ...
          <CardContent className="px-4 pb-4 pt-3">
            ...
            <div className="space-y-3">
              {upcomingCommissions.map((commission, index) => <div key={index} className="flex justify-between text-xs">
                  <div>
        ...
        <Card className="bg-black border-gray-800 shadow-lg col-span-1">
          ...
          <CardContent className="px-4 pb-4 pt-3">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="flex items-center bg-gray-800/50 px-2 py-0.5 rounded-full">
                <TrendingUp size={12} className="text-green-400 mr-1 mx-[102px]" />
        ...
        <Card className="bg-black border-gray-800 shadow-lg col-span-1">
          ...
          <CardContent className="px-4 pb-4 pt-3 space-y-3">
            {recentActivity.map((activity, index) => <div key={index} className="flex items-center">
                ...
                <div className="flex-1 text-xs">
                  ...
                  <div className="text-gray-400 mt-0.5 py-0 my-0 px-0 mx-0">
